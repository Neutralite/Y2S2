...
public:
	...
	//void setWidthRatio(float _VAL);
	//void setHeightRatio(float _VAL);
	//void setBottomLocation(float _VAL);
	//void setRightLocation(float _VAL);
	//
	//void setWidthAndHeightRatio(vec2 _VAL);
	//void setBottomRightCornerRatio(vec2 _VAL);
	//
	//void setDimensions(vec4 _VAL);
	//
	//float getWidthRatio();
	//float getHeightRatio();
	//float getBottomLocation();
	//float getRightLocation();
	//
	//vec2 getWidthAndHeightRatio();
	//vec2 getBottomRightCorner();
	//
	//vec4 getDimensions();
...
private:
	...
	//vec4 dimensions = vec4(1.f, 1.f, 0.f, 0.f);
};
...
public:
	...
	{
		addDepthTarget();
		addColorTarget(GL_RGB8); // 0 Albedo
		addColorTarget(GL_RGB8); // 1 Normal
		addColorTarget(GL_R11F_G11F_B10F); // 2 Emissive
	}
